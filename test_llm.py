...
#         # Define the quantization configuration with the required nf4 type for CPU
#         quantization_config = BitsAndBytesConfig(
#             load_in_4bit=True,
#             bnb_4bit_quant_type="nf4",
#             bnb_4bit_compute_dtype=torch.bfloat16 # or torch.float32
#         )

#         self.tokenizer = AutoTokenizer.from_pretrained(model_name)
        
#         # Load the model with the corrected quantization config
#         self.model = AutoModelForCausalLM.from_pretrained(
#             model_name,
#             quantization_config=quantization_config,
#             device_map="auto" # This will correctly map to CPU
#         )
#         print("✅ Model loaded successfully in 4-bit on CPU.")
...
# if __name__ == '__main__':
#     model_to_use = "Qwen/Qwen2-0.5B-Instruct"
#     llm = LanguageModel(model_name=model_to_use)
    
#     messages = [
#         {"role": "system", "content": "Travel Planner"},
#         {"role": "user", "content": "Plan a trip of 4 days for a group of 10 college friends."}
#     ]
#     your_prompt = llm.tokenizer.apply_chat_template(
#         messages, tokenize=False, add_generation_prompt=True
#     )
    
#     print(f"\nPROMPT: {your_prompt}")
#     response = llm.generate(your_prompt)
